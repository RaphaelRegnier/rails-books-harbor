...
addresses = ["Mcgill University, canada", "Université de Montréal, canada", "Université du Québec à Montréal, canada", "Concordia University, canada", "HEC Montréal, canada", "Quebec city, canada", "Collège de Maisonneuve, canada", "LaSalle College, canada", "École Polytechnique de Montréal, canada", "Vanier College, canada"]
